...
class ProductAddVendor extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (selectedPro != null) {
      ...
      // controller.pickedImage.value = File(selectedPro.image);
      controller.selectedCategory.value = selectedPro.category;
    }
    return PopScope(
      canPop: true,
      onPopInvokedWithResult: (didPop, result) {
        if (didPop) {
          controller.seletedProduct.value != null;
        }
      },
      child: Scaffold(
        appBar: AppBar(
          title: Text(controller.seletedProduct.value != null
              ? 'Edit Product'
              : 'Add New Product'),
        ),
              ...
              () => Column(
                ...
                children: [
                  ...
                  SizedBox(
                    ...
                    child: CommonButton(
                        onPress: () {
                          if (controller.seletedProduct.value != null) {
                            controller.editProduct(
                                context: context,
                                formKey: _formKey,
                                productId: controller.seletedProduct.value!.id,
                        ...
                        buttonText: controller.seletedProduct.value != null
                            ? 'Update Product'
                            : "Add Product"),
                  ),
                ],
